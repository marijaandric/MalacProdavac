...
{
    Credential = GoogleCredential.FromFile("smalltrades-74681-firebase-adminsdk-f0k76-16312ec3fb.json")
});
...
builder.Services.AddHostedService<BackgroundHandlerService>();
